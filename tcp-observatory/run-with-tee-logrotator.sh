#!/usr/bin/env bash
# Runs tcp-observatory server with output teed to both terminal and rotating log.
# Logs go to /tmp/claude/observatory/tcp-observatory.log (rotated at 10MB, keeps 10 files).
...
LOG_FILE="${LOG_DIR}/tcp-observatory.log"
